...
class LexerApp:
    def __init__(self):
        ...
        self.text_label = tk.Label(text="Eduardo Gonzalez Aguilar", height=2)
        ...
        self.tree = ttk.Treeview(self.windows, columns=("Linea", "Token", "Valor", "Reservada", "Numero", "Identificador", "Símbolo", "Operador"))
